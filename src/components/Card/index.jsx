    ...
    <div className="w-full h-80 p-2 bg-white text-blue-gray-800 shadow-md rounded-xl duration-500 hover:shadow-2xl text-sm">
      <div className="h-full">
        <div className="flex flex-wrap">
          ...
          <span className="text-indigo-900 font-sans font-bold my-auto uppercase ">
            {coinName}
          </span>
        </div>
        ...
        <div className="grid grid-cols-3 w-full pt-2">
          <div className="block">
            <Typography
              variant="small"
              className="font-bold mr-2 text-blue-gray-300 text-left"
            >
              Compra
            </Typography>
            ...
            <div className="text-left my-2">
              <Typography
                variant="small"
                className="text-indigo-900 font-sans font-bold"
              >
                ${fromExPrice}
              </Typography>
            </div>
          ...
          <div className="block">
            <Typography
              variant="small"
              className="font-bold mr-2 text-blue-gray-300 text-right"
            >
              Venda
            </Typography>
        ...
        <div className="p-2">
          <div className="grid grid-cols-2 w-full mb-2">
            <div className="block">
              <Typography
                variant="small"
                className="font-bold text-blue-gray-300 text-left"
              >
                SPREAD
              </Typography>
              <div className="flex flex-wrap">
            ...
            <div className="block">
              <Typography
                variant="small"
                className="font-bold text-blue-gray-300 text-right"
              >
                TAXAS
              </Typography>
